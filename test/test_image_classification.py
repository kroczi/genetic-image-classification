...
from model.area import CircleArea, RectangleArea, Histogram
from model.data_types import Position, Size, distance
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_distance_function_different_bin(self):
        ...
        self.assertAlmostEqual(distance(histogram_a, histogram_b), math.sqrt(125), delta=0.01)
    ...
    def test_calculate_gradient_equals_zero_rectangle_area(self):
        ...
        size = Size(10, 10)
        rArea = RectangleArea(myImage, position.x, position.y, size.height, size.width)
